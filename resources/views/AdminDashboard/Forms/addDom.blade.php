...
<div class="content-wrapper">
        ...
        <div class="row mb-2">
          <div class="col-sm-8">
            <h4 class="fw-bold py-3 mb-4" >
                ...
                <span class="text-muted fw-light" > /</span> Ajouter Domaine</h4>
          </div><!-- /.col -->
    ...
    <section class="content">
        ...
        <div class="card border-dark shadow p-3 mb-5 bg-body rounded">
            <div class="card-header text-center h3" style="color:#22577E">Domaine de recherche</div>
            <div class="card-body text-dark">
                <form action='/store-dom' method="post" enctype="multipart/form-data">
                  {{ csrf_field() }}
