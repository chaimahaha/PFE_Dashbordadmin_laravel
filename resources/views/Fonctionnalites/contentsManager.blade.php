...
@section('content')
        ...
        <li class="menu-item m-1">
                <div class="btn btn-info  dropdown-toggle w-100 " >INFORMATIONS GÉNERALES</div>
            ...
            <li class="menu-item m-1">
                <span class="btn btn-info dropdown-toggle w-100" data-toggle="dropdown">SERVICES</span>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="pages-misc-error.html" class="menu-link">
