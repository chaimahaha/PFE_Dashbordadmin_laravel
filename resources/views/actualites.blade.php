...
<div class="container"style="max-width:90%;">             
  <div class="card mt-5 shadow p-3 mb-5 bg-body rounded ">
      <div class="card-header text-center fw-bold fs-4" style="color:#22577E">A LA UNE</div>
      <div class="card-body "> 
        <div class="row">
            ...
            <div class="card mb-3" style="max-width: 500px;">
              <div class="row">
                <div class="col-md-3 m-1 ">
                  <img src="{{url('actuality_image/'.$act->image)}}"alt="" width="100px" height="100px" />
                </div>
                <div class="col-md-6">
                  <div class="card-body">
                    <h5 class="card-title fs-3" style="color:#0d47a1">{{$act->titre}}</h5>
                    <p class="card-text fs-5">{{$act->description}}</p>
                    <p class="card-text"><small class="text-muted">{{$act->created_at}}</small></p>
                  </div>
                </div>
              </div>
            </div>
